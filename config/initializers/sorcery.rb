...
Rails.application.config.sorcery.submodules = [:remember_me, :reset_password, :user_activation, :brute_force_protection, :activity_logging]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `[:email]`
    #
    user.username_attribute_names = :names
